...
export function App() {
  ...
  return (
    <main className="app-shell">
      ...
      <footer className="status-bar"><span><i className={ready ? "ready" : ""} /> {ready ? "Supervisor connected" : "Waiting for supervisor"}</span><span>SQLite/WAL persistence</span><span>MCP over stdio</span><span>Data stays local unless you export it</span><span className="creator-credit">Created by <a href="https://github.com/lovecatisgood-sudo" target="_blank" rel="noreferrer">Siamese Cat Dev</a></span></footer>
